...
parser = argparse.ArgumentParser(description="Play trained PPO example2 Lift")
parser.add_argument("--checkpoint", type=str, default="checkpoints/example2.zip")
parser.add_argument("--vecnorm",    type=str, default="checkpoints/example2_vecnorm.pkl",
...
from source.example2.tasks.lift.lift_env import LiftEnv
from source.example2.tasks.lift.lift_env_cfg import LiftEnvCfg
