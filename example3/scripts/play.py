...
parser = argparse.ArgumentParser(description="Play trained PPO example3 Lift")
parser.add_argument("--checkpoint", type=str, default="checkpoints/example3.zip")
parser.add_argument("--vecnorm",    type=str, default="checkpoints/example3_vecnorm.pkl",
...
from source.example3.tasks.lift.lift_env import LiftEnv
from source.example3.tasks.lift.lift_env_cfg import LiftEnvCfg
