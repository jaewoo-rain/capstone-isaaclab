"""motion3 — Insert RL 학습 스크립트 (PPO + VecNormalize + early stop).

train_grasp.py 패턴 그대로 + InsertEnv 사용.

실행:
    ./isaaclab.sh -p source/motion3/scripts/train_insert.py --headless --num_envs 128 --timesteps 1000000
    ./isaaclab.sh -p source/motion3/scripts/train_insert.py --headless --resume --timesteps 500000
"""
...
parser.add_argument("--name", type=str, default="motion3_insert")
...
def main():
    ...
    log_dir = "source/motion3/logs/insert"
