...
parser.add_argument("--checkpoint", type=str, default="checkpoints/motion3_insert.zip")
parser.add_argument("--vecnorm", type=str, default="checkpoints/motion3_insert_vecnorm.pkl")
