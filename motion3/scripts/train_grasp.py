"""motion3 — Grasp RL 학습 스크립트 (PPO + VecNormalize + early stop).
...
- TensorBoard log: source/motion3/logs/grasp/

실행:
    ./isaaclab.sh -p source/motion3/scripts/train_grasp.py --headless --num_envs 128 --timesteps 1000000
    # resume:
    ./isaaclab.sh -p source/motion3/scripts/train_grasp.py --headless --resume --timesteps 500000
"""
...
from source.motion3.tasks.grasp.grasp_env import GraspEnv
from source.motion3.tasks.grasp.grasp_env_cfg import GraspEnvCfg
...
def main():
    ...
    log_dir = "source/motion3/logs/grasp"
