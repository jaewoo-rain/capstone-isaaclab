...
parser.add_argument("--checkpoint", type=str, default="checkpoints/example5_2.zip")
parser.add_argument("--vecnorm",    type=str, default="checkpoints/example5_2_vecnorm.pkl",
