...
parser = argparse.ArgumentParser(description="Play trained OMY 3x3 grid place PPO")
parser.add_argument("--checkpoint", type=str, default="checkpoints/omy_place_grid_ppo.zip")
