...
parser = argparse.ArgumentParser(description="Play trained OMY lift PPO")
parser.add_argument("--checkpoint", type=str, default="checkpoints/omy_lift_ppo.zip")
