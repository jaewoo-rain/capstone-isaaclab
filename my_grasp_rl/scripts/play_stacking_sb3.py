...
parser = argparse.ArgumentParser(description="Play trained PPO stacking policy")
parser.add_argument("--checkpoint", type=str, default="checkpoints/stacking_franka_ppo.zip")
...
def main():
    vecnorm_path = "checkpoints/stacking_franka_vecnormalize.pkl"

    cfg = StackingFrankaEnvCfg()
    cfg.scene.num_envs = args_cli.num_envs

    env = StackingFrankaEnv(cfg=cfg, render_mode="human")
